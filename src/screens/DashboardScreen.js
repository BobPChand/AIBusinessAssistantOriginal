...
export default function DashboardScreen({ navigation }) {
  ...
  const quickActions = [
    ...
    { icon: 'checkmark-circle', label: 'Tasks', color: '#F5A623', screen: 'Tasks' },
    { icon: 'bar-chart', label: 'Insights', color: '#7ED321', screen: 'Insights' },
    { icon: 'settings', label: 'Settings', color: '#9B59B6', screen: 'Settings' },
  ];
        ...
        <View style={styles.card}>
          <View style={styles.cardRow}>
            ...
            <View style={styles.cardText}>
              ...
              <Text style={styles.cardSub}>Powered by GPT-4o · AIBusinessAssistant.ai</Text>
            </View>
